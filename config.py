...
WORKSTATION_OWNER_PATH = DATA_DIR / ".workstation-owner.local.json"
STORY_STOP_REQUEST_PATH = DATA_DIR / ".story-stop-request.json"
...
RECOVERY_EVIDENCE_DIR = DATA_DIR / "checkpoints" / "recovery-evidence"
PROFILE_EVIDENCE_DIR = DATA_DIR / "checkpoints" / "profile-evidence"
LOCAL_EVIDENCE_DIR = DATA_DIR / "evidence-local"
EVIDENCE_OUTBOX_DIR = DATA_DIR / "evidence-outbox"
...
WORKSTATION_LEASE_HOURS = 2
WORKSTATION_LEASE_RENEW_MINUTES = 15
...
PASSAGE_MAX_PARAGRAPHS = 12
PASSAGE_MAX_CHARS = 12_000
STORY_EXPANSION_VERSION = "seed-window-v5"
STORY_CONTEXT_BEFORE_PARAGRAPHS = 2
STORY_CONTEXT_AFTER_PARAGRAPHS = 3
STORY_REFERENCE_SCAN_PARAGRAPHS = 64
STORY_REFERENCE_CONTEXT_PARAGRAPHS = 4
STORY_MIN_CHARS = 350
STORY_MIN_SENTENCES = 3
STORY_ENRICHMENT_WORKERS = 3
STORY_ENRICHMENT_MAX_WORKERS = 16
STORY_AUTO_MIN_WORKERS = 3
STORY_AUTO_MAX_WORKERS = 8
STORY_AUTO_SUCCESS_WINDOW = 4
